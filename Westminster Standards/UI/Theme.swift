...
class Theme: ObservableObject {
    ...
    var primaryTextColor: Color { Color(red: 0.21, green: 0.22, blue: 0.23) }
    var secondaryTextColor: Color { Color(red: 0.26, green: 0.27, blue: 0.28) }

    var subduedIconColor: Color { Color(red: 0.37, green: 0.38, blue: 0.4) }

    let titleFont: Font = .custom("EBGaramond-Medium", size: 24)
    let headingFont: Font = .custom("EBGaramond-Medium", size: 24)
...
class LightTheme: Theme {
    ...
    override var primaryTextColor: Color { Color(red: 0.21, green: 0.22, blue: 0.23) }
    override var secondaryTextColor: Color { Color(red: 0.26, green: 0.27, blue: 0.28) }
...
class DarkTheme: Theme {
    ...
    override var secondaryTextColor: Color { Color(red: 0.78, green: 0.79, blue: 0.80) }
